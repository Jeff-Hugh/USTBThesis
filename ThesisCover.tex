...
\zihao{-2} \textbf{北京科技大学博士学位论文} \par
\vspace{30mm}

\zihao{4}
%论文主标题
\centerline{ \textbf{论文题目：} \ThesisTitleCN } \par    %强制只使用一行
...
\centerline{ \textbf{作者：} \AuthorCN } \par
\vspace{70mm}
...
\zihao{4} \makebox[7em][s]{\textbf{指导小组成员：}} & \zihao{5} \underline{\makebox[3cm]{\SubTeacherCN \qquad \TeacherJobtitle}} & \zihao{4} \textbf{单位：} & \zihao{5} \underline{\makebox[3cm]{\SubTeacherDepartment}} \\
